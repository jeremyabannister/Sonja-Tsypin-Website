class AboutPage extends JABView {
	...
	configureBioText () {
		...
		if (this.bioText.text == '') {
			this.bioText.text = "Sonja Tsypin is a cinematographer born and raised in New York City and currently based in Los Angeles. Sonja has photographed award-winning films ranging in form, content, and genre and she is committed to always finding fresh ways of bringing the unique voice of each project and collaborator to life. She recently recieved First Place in the international 2016 KODAK Cinematography Scholarship Awards for her short film <span id='powderRoomSpan---" + this.id + "' style='color:white; cursor:pointer'>Powder Room</span>. Sonja comes from a background in fine art and she approaches cinematography as a culmination of the various artforms that she has explored over the years including painting, sculpture, installation, and performance art (view work <a target='_blank' href='http://www.sonjatsypin.weebly.com'><span style='color:white'>here</span></a>). Her artwork was awarded two regional Gold Keys and a national Gold Medal in the Scholastic Art and Writing Awards. Sonja is currently studying towards a master's degree in cinematography at the prestigious American Film Institute (AFI) Conservatory in Los Angeles."
